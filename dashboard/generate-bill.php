...
$conn = new mysqli("localhost", "root", "", "Pritam");
...
if (isset($_GET['order'])) {
    ...
    // Title
    $pdf->Cell(0, 10, 'SPICY RESTAURANT', 1, 1, 'C');
    ...
    $pdf->Cell(0, 10, 'Spicy Email: spicy0support@gmail.com', 1, 1, 'C');
    $pdf->Cell(0, 10, 'Spicy Phone: +91 6372963705', 1, 1, 'C');
    ...
    $pdf->Cell(0, 10, 'Spicy Restaurant, MPC Road, Takatpur, Baripada, Mayurbhanj, Odisha-757003', 0, 1, 'C');
