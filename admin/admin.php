...
define("APPURL", "http://localhost/Pritam");
?>
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../assets/images/mklogo7.jpg">
    <title>Admin pannel - Moom's Kitchen</title>
</head>
                ...
                <div aria-label="breadcrumb mb-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb d-flex justify-content-center align-items-center">
                            <img src="../assets/images/mklogo.jpg" alt="logo" width="130">
                            <li class="breadcrumb-item"><a href="../index.php">Mom's Kitchen</a></li>
                    ...
                    <div class="tab-pane" id="menuupdates">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                ...
                                <form method="post" action="functions/add-menu-item.php" enctype="multipart/form-data" >
                                    ...
                                    <!-- <input type="text" name="image_path" value="./assets/images/menu/non-veg/" class="form-control mb-2" placeholder="Image Path" required> -->
