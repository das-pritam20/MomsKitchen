...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../assets/images/nsr.png">
    ...
    <div class="container">
        ...
        <header>
            <nav class="navbar">
                <div class="navbar-wrapper">
                    <a href="#">
                        <img src="../assets/images/Nutrisynclogo.png" alt="logo" width="130">
        ...
        <main>
            ...
            <s<section class="contact-section" id="home">
                ...
                <br><center>
                <div class="form-question"><h3>Are You a user <u><a href="../new-login.php" style="display: inline; color: #216aca;" onmouseover="this.style.color='#03d9ff'" onmouseout="this.style.color='#216aca'">Login Here</h3></a></u></div>
              </center>
              </div>
            </div>
          ...
          <img src="../assets/images/ring.svg" alt="ring shape" class="shape shape-5" width="40">
                ...
                <footer>
                    <div class=" footer-wrapper">
                        <a href="#">
                            <img src="../assets/images/nm.png" alt="logo" class="footer-brand" width="150">
                        </a>
                        ...
                        <p class="copyright">&copy; Nigamanand Mallik. All Rights Reserved.</p>
                    </div>
                </footer>
    </div>
