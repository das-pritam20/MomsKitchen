...
<?php require "includes/header.php"; ?>
    <main>
      ...
      <section class="home" id="home">
        ...
        <?php
          ...
          $adminMessageQuery = "SELECT `id`, `message`, `enable_meessage` FROM `admin_message`";
          ...
          <p class="home-text">
            Your tongue also have it's own dreams. Mom's Kitchen is the perfect place for your fantasies.
          </p>
      ...
      <section class="about" id="about">
        ...
        <div class="about-right">
         ...
         <img src="./assets/images/pritam_image.png" alt="signature" class="signature" width="110">
        </div>
      </section>
          ...
          <a href="#">
            ...
            <div class="product-card">
              ...
              <div class="product-content">
                ...
                <div class="wrapper">
                  <h3 class="product-name">Chappati</h3>
      ...
      <section class="testimonials" id="testimonials">
        ...
        <div class="testimonials-grid">
          ...
          <div class="testimonials-card">
            ...
            <div class="customer-info">
              <div class="customer-img-box">
                <img src="./assets/images/rj.jpg" alt="customer image" class="customer-img" width="100" loading="lazy">
              </div>

              <h5 class="customer-name">Rajiblochan Pramanik</h5>
            </div>
          ...
          <div class="testimonials-card">
            ...
            <p class="testimonials-text">
            The Mom's Kitchen is fantastic! The food is delicious, the service is impeccable, and the atmosphere is cozy and inviting.
            </p>
          
            <div class="customer-info">
              <div class="customer-img-box">
                <img src="./assets/images/pk.jpg" alt="customer image" class="customer-img" width="100" loading="lazy">
              </div>
          
              <h5 class="customer-name">Pritam Das</h5>
            </div>    
          </div>
        </div>
      </section>
    ...
    <footer>
      <div class="footer-wrapper">
        <a href="#">
          <img src="./assets/images/mklogo.jpg" alt="logo" class="footer-brand" width="150">
        </a>
        ...
        <p class="copyright">&copy; Pritam Das. All Rights Reserved.</p>
      </div>
    </footer>
  </div>
